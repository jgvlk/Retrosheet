...
print('||MSG', datetime.now(), '|| STARTING RAW DATA LOAD TO [Retrosheet] DB')
...
# Load raw game data
print('||MSG', datetime.now(), '|| LOADING RAW REGULAR SEASON GAME DATA TO [Retrosheet] DB')
...
print('||MSG', datetime.now(), '|| LOADING RAW POSTSEASON GAME DATA TO [Retrosheet] DB')
...
print('||MSG', datetime.now(), '|| LOADING RAW ALL-STAR GAME DATA TO [Retrosheet] DB')
...
# Load raw EVENT data
print('||MSG', datetime.now(), '|| LOADING RAW REGULAR SEASON EVENT DATA TO [Retrosheet] DB')
...
print('||MSG', datetime.now(), '|| LOADING RAW POSTSEASON EVENT DATA TO [Retrosheet] DB')
...
print('||MSG', datetime.now(), '|| LOADING RAW ALL-STAR EVENT DATA TO [Retrosheet] DB')
